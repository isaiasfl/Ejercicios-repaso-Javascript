...
export const productos = [
  {
    ...
    descripcion:
      'Portátil de alta gama con procesador Intel i7, 16GB RAM y SSD de 512GB',
  ...
  },
  {
    ...
    descripción:
      'Auriculares inalámbricos con cancelación de ruido y 30h de autonomía',
    categoría: 'Electrónica',
    precio: 79.99,
  ...
  },
  {
    ...
    descripción:
      'Silla de oficina con soporte lumbar y reposabrazos ajustables',
    categoría: 'Muebles',
    precio: 249.99,
  ...
  },
  {
    ...
    descripción:
      'Teclado mecánico con iluminación RGB personalizable y switches azules',
    categoría: 'Electrónica',
    precio: 89.99,
    precioAnterior: null,
    stock: 35,
...
export const pedidos = [
  ...
  },
  {
    id: 1003,
    idUsuario: 4,
    productos: [{ idProducto: 105, cantidad: 2, precioUnitario: 329.99 }],
...
export const numeros = [
  5, 12, 8, 130, 44, 23, 67, 2, 99, 34, 56, 78, 90, 11, 33,
];
...
export const nivelesUsuario = [
  {
    id: 'básico',
    nombre: 'Básico',
    beneficios: ['Soporte por email'],
    minPuntos: 0,
  },
  {
    id: 'estándar',
    nombre: 'Estándar',
    beneficios: ['Soporte prioritario', 'Descuentos exclusivos'],
    minPuntos: 500,
  },
  {
    id: 'premium',
